...
and then rename it: hover over the instance name and click on the
edit button to change name.) You will then deploy a two-node HDFS
cluster and a two-node Spark cluster on these two EC2 instances. 
