...
(or [the original version](http://infolab.stanford.edu/~backrub/google.html)(§2.1), [the Wikipedia version](https://en.wikipedia.org/wiki/PageRank#Simplified_algorithm)),
